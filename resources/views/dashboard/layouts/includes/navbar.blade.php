<!-- start header -->
		<div class="page-header navbar navbar-fixed-top">
			<div class="page-header-inner ">
				...
				<!-- logo end -->
				<ul class="nav navbar-nav {{ $navbar }} in">
					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown language-switch">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                        ...
                                        @endphp
                                        @if ($currentLocal == 'ar')
                                         <img src="{{ asset('frontEnd/assets/') }}/img/flags/{{ $currentLocal }}.png" class="position-left" alt="">
                                                العربية
                                        @else
                                         <img src="{{ asset('frontEnd/assets/') }}/img/flags/{{ $currentLocal }}.png" class="position-left" alt="">
                                            English
                                    ...
                                    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                        <li>
                                            <a rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                               ...
                                               <img src="{{ asset('frontEnd/assets/') }}/img/flags/{{  $localeCode }}.png" alt="">
                                                {{ $properties['native'] }}
                                            </a>
                                        </li>
                                    @endforeach
						...
						<li class="dropdown dropdown-user">
							<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
								data-close-others="true">
								<img alt="" class="img-circle " src="{{ asset('frontEnd/assets/') }}/img/prof/user.png" />
